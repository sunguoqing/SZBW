 ...
 * 
 * Fields that annotated as RequiredParam will be send to the REST server
 * with NULL check. {@link RRException}} will be thrown if required field is NULL at runtime.
 * 
